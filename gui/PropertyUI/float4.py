...
# Form implementation generated from reading ui file 'float4.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.v3 = QtWidgets.QDoubleSpinBox(Form)
        self.v3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.v3.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.v3.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectToNearestValue)
        self.v3.setProperty("showGroupSeparator", False)
        self.v3.setDecimals(4)
        self.v3.setMinimum(-1e+97)
        self.v3.setMaximum(1e+51)
        self.v3
